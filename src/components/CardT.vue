<template>
  <div>
    <q-card flat class="bg-pink-4 text-white montserrat" style="min-width: 300px">
      <q-card-section>
        <div class="text-h6">{{ title }}</div>
        <div class="text-body1">- {{ props.body[0] }}</div>
        <div class="text-body1 q-mb-xl">- {{ props.body[1] }}</div>
        <div class="q-mb-xl">-</div>
      </q-card-section>
      <q-card-actions>
        <q-btn flat type="a" @click="openDrawer">Agendar</q-btn>
      </q-card-actions>
    </q-card>
